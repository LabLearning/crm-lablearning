-- ============================================================
-- Migration 067 : filtre de période sur sessions_page_data
-- Par défaut la page Sessions ne charge plus les 354 sessions
-- passées : depuis/jusqua bornent date_fin côté SQL.
-- ============================================================

-- L'ancienne signature à 1 argument doit disparaître, sinon
-- l'appel RPC devient ambigu entre les deux versions.
DROP FUNCTION IF EXISTS sessions_page_data(uuid);
...
SELECT jsonb_build_object(
  'sessions', COALESCE((
    ...
    WHERE s.organization_id = org
      -- les sessions sans date restent visibles dans la vue par défaut (brouillons)
